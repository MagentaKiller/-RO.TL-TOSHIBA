...
const yourID = "293485395138838528"; //Instructions on how to get this: https://redd.it/40zgse
const setupCMD = "!on";
...
const roles = ["Nitain", "Riven", "Helmet", "Baro", "Warframeuri", "Reactor", "Catalyst", "Exilus", "Aura", "SeturiPrime"];
const reactions = ["Nitain", "RivenMod", "HelmetBlueprint", "VoidTraderBaro", "excal", "Reactor", "Catalyst", "Exilus", "AuraMod", "Anarhie"]; // For custom emojis, provide the name of the emoji
