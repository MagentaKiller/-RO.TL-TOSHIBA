...
const roles = ["Nitain", "Riven", "Helmet", "Baro", "Reactor", "Catalyst", "Exilus", "Forma", "Invasions", "News", "Wraith", "Vandal", "Alerts"];
const reactions = ["Nitain", "RivenMod", "HelmetBlueprint", "VoidTraderBaro", "Reactor", "Catalyst", "Exilus", "Forma", "space_invader", "new", "red_square", "blue_square", "warning"]; 
